...
💻 Machine Learning Engineer | Generative AI | Embedded AI Systems  

Machine learning–focused Electrical Engineering student at NUST (CEME)  
with hands-on experience in **signal processing, deep learning, and agentic AI systems**.  

I build **real-world ML systems** that are reliable, scalable, and impactful.
...
⚙️ Tools  
`Git` `GitHub` `Docker` `LangSmith` `Linux`
